...
export class MonacoConvergenceAdapter {
  ...
  private _remoteCursorManager: MonacoCollabExt.RemoteCursorManager;
  private _cursorReference: any;
  private _remoteSelectionManager: MonacoCollabExt.RemoteSelectionManager;
  ...
  set monacoEditor(value: any) {
	this._monacoEditor = value;
  }
